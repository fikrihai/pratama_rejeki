...
<div class="container-fluid">
    ...
    <div class="card " style="width:50%;margin-bottom: 80px;"> 
        ...
        <?php foreach ($jabatan as $j):?>
            <form method="POST" action="<?php echo base_url('admin/DataJabatan/updateDataAksi/'. $j->id_jabatan)?>">
            ...
            <a class="btn btn-sm btn-primary" href="<?php echo base_url('admin/DataJabatan/back') ?>"> back</a>
        </form>
        <?php endforeach;?>
        </div>
    </div>
